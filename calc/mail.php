	...
	foreach (array_values($data) as $key=>$val){
		$options .=
			'<tr'.($key%2==1 ? ' class="even" bgcolor="#f4f4f4" style="background: #f4f4f4;"' : '').'>
				<td height="26px" width="20px" style="width:20px;">&nbsp;</td>
				<td class="param" height="26px" valign="center" width="150px" style="color: #686868; font-family: Tahoma, Helvetica, sans-serif; font-size: 14px;width: 150px;">'.$val['title'].'</td>
	...
	return $data!==false ?
		...
		<tr>
			<td class="gray_bg" align="center" valign="center" bgcolor="#f4f4f4" style="-moz-border-radius: 5px; -webkit-border-radius: 5px; background: #f4f4f4; border-radius: 5px; height: 50px;">
				<table width="100%" cellspacing="0" cellpadding="0" border="0" style="border: none; border-collapse: collapse;">
					<tr>
						<td height="50px" width="21px" style="width:21px;">&nbsp;</td>
						<td class="storey_name" height="50px" align="left" valign="center" width="70px" style="color: #686868; font-family: Tahoma, Helvetica, sans-serif; font-size: 10px; height: 50px; letter-spacing: 0.1em; line-height: 15px; text-align: left; text-transform: uppercase; vertical-align: middle; width: 70px;">площадь этажа</td>
			...
			'<tr>
				<td align="left" valign="top" height="175px">
					<a href="'.$val['url'].'" target="_blank">
						<img src="'.$val['img'].'" width="530px" height="175px" style="border: 0px; display: block;width: 530px;">
					</a>
				</td>
			</tr>';
	}
...
function socials($socials){
	...
	foreach ($socials as $val){
		$socials_html .=
			'<td width="47px" align="right" style="width:47px;">
				<a href="'.$val['url'].'" target="_blank">
					<img src="'.$val['img'].'" width="37px" height="37px" style="border: 0px; display: block;width: 37px;">
				</a>
			</td>';
	}
...
$socials = array(
	array(
		'url'=>'https://t.me/skd_dom',
		'img'=>$path_to_images.'/telegram.png' //37x37 px
	),
	array(
		'url'=>'https://vk.com/skddom',
		'img'=>$path_to_images.'/vk.png' //37x37 px
	),
	array(
		'url'=>'https://www.facebook.com/skddom',
		'img'=>$path_to_images.'/facebook.png' //37x37 px
	),
	array(
		'url'=>'https://plus.google.com/+Skd-domRu',
		'img'=>$path_to_images.'/google-plus.png' //37x37 px
	),
	array(
		'url'=>'https://www.youtube.com/channel/UCApykxq-nTJaiKBwkIFSiLg',
		'img'=>$path_to_images.'/youtube.png' //37x37 px
	),
	array(
		'url'=>'https://www.instagram.com/skd_dom/',
...
$replace = array(
	...
	'%second_storey%'=>email_storey_html($data['second_storey'], $data['areas']['second_storey'], '2 этаж'),
