...
class nc_tpl_template_view {
    ...
    public function partial($name, $data = array()) {
        $partial_file = nc_core::get_object()->template->get_partials_path($this->root_template_id, $name);
        return new nc_tpl_template_partial($this->root_template_id, $partial_file, $data);
    }
