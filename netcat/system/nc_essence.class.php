...
abstract class nc_Essence extends nc_System {
    ...
    public function convert_system_vars($env_array) {
        ...
        if (isset($env_array['Created'])) {
            $nc_core->page->update_last_modified_if_newer($env_array['Created'], $this->last_modified_type);
        }

        if (isset($env_array['Updated'])) {
            $nc_core->page->update_last_modified_if_newer($env_array['Updated'], $this->last_modified_type);
        }

        if (isset($env_array['LastModified'])) {
            $nc_core->page->update_last_modified_if_newer($env_array['LastModified'], $this->last_modified_type);
        }
