...
<div class="nc-modal-dialog nc-netshop-condition-dialog">
    <style scoped>
        ...
        .nc-netshop-condition-dialog-list-column .nc-netshop-item-variant {
            padding-left: 30px;
        }        
    </style>
    
    <div class="nc-modal-dialog-header"><h2><?= NETCAT_MODULE_NETSHOP_CONDITION_ITEM_SELECTION ?></h2></div>
    <div class="nc-modal-dialog-body nc-padding-0">
        ...
        <div class="nc--fill nc-netshop-condition-dialog-tree-column menu_left_block">
            <ul class="nc-netshop-condition-dialog-tree" id="nc_netshop_condition_editor_item_selection_dialog_tree"></ul>
        </div>
    ...
    <script>
        (function() {
            ...
            function selectItem() {
                ...
                // The cell has "data-object" attribute ("Class_ID:Message_ID"),
                ...
                dialog.get_option("condition_dialog_target_input").val(el.data('object'));
            ...
            // --- tree initialization ---
            function initTree() {
                var treeId = 'nc_netshop_condition_editor_item_selection_dialog_tree',
                    treeUrl = '<?= "$condition_data_folder/json/subdivision_tree.php?site_id=$site_id&node=" ?>',
                ...
                tree.actions = {
                    selectNode: function(id) {
                        $nc.get('<?= "$condition_data_folder/html/object_list.php" ?>',
                              { subdivision_id: id },
                              function(response) {
                                  listColumn.html(response)
                                      .find(".item").click(selectItem);
                              });
                        tree.selectNode('sub-' + id);
                        return false;
                    }
                };
