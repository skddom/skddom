...
?>
<div class="nc_admin_fieldset_head"><?= !empty($bundle_id) ? NETCAT_MODULE_NETSHOP_YANDEX_MARKET_BUNDLE_EDIT : NETCAT_MODULE_NETSHOP_YANDEX_MARKET_BUNDLE_ADD; ?></div>
<?php
...
$row = $form->add_row(NETCAT_MODULE_NETSHOP_YANDEX_MARKET_BUNDLE_TYPE)->horizontal();
