...
define("NETCAT_MODULE_COMMENTS_MODERATOR_CLOSE", "Запретить комментарии");
define("NETCAT_MODULE_COMMENTS_MODERATOR_OPEN", "Разрешить комментарии");
...
define("NETCAT_MODULE_COMMENTS_ADD_FORM_ADD_BUTTON", "Добавить");
define("NETCAT_MODULE_COMMENTS_ADD_FORM_SUBSCRIBE_BUTTON", "Подписать");
...
define("NETCAT_MODULE_COMMENTS_ADMIN_TEMPLATE_SUBSCRIBES", "Управление подписками");
...
define("NETCAT_MODULE_COMMENTS_ADMIN_COMMENTS_SUBSCRIBES_SELECT", "Выборка подписок");
define("NETCAT_MODULE_COMMENTS_ADMIN_NO_COMMENTS", "Нет комментариев");
define("NETCAT_MODULE_COMMENTS_ADMIN_NO_SUBSCRIBES", "Нет подписок");
define("NETCAT_MODULE_COMMENTS_ADMIN_ESSENCE", "Сущность");
define("NETCAT_MODULE_COMMENTS_ADMIN_USER", "Пользователь");
define("NETCAT_MODULE_COMMENTS_ADMIN_CATALOGUE", "Сайт");
define("NETCAT_MODULE_COMMENTS_ADMIN_SUBDIVISION", "Раздел");
define("NETCAT_MODULE_COMMENTS_ADMIN_CC", "Инфоблок");
define("NETCAT_MODULE_COMMENTS_ADMIN_MESSAGE", "Объект");
define("NETCAT_MODULE_COMMENTS_ADMIN_NONE_CC", "Нет инфоблоков");
define("NETCAT_MODULE_COMMENTS_ADMIN_NONE_CC", "Нет разделов");
define("NETCAT_MODULE_COMMENTS_ADMIN_WHOLESUB", "с подразделами");
define("NETCAT_MODULE_COMMENTS_ADMIN_LOAD", "- Загрузка... -");
...
define("NETCAT_MODULE_COMMENTS_ADMIN_QTY", "Количество на странице");
define("NETCAT_MODULE_COMMENTS_ADMIN_SUBS_QTY", "Количество подписок на страницу");
define("NETCAT_MODULE_COMMENTS_ADMIN_SUBSCRIBERS_USER", "Подписчик");
define("NETCAT_MODULE_COMMENTS_ADMIN_FROM_LIST", "Из списка");
define("NETCAT_MODULE_COMMENTS_ADMIN_NO_HIERARHY", "Показывать подписки только для выбранной сущности");
define("NETCAT_MODULE_COMMENTS_ADMIN_DATE", "Дата");
define("NETCAT_MODULE_COMMENTS_ADMIN_DATE_FROM", "За период с ");
define("NETCAT_MODULE_COMMENTS_ADMIN_DATE_TO", " по ");
...
define("NETCAT_MODULE_COMMENTS_ADMIN_SETTINGS_ADD_BLOCK_FIRST", "Выводить блок добавления сверху стены комментариев");
define("NETCAT_MODULE_COMMENTS_ADMIN_SETTINGS_SAVE_OK", "Настройки комментариев сохранены.");
define("NETCAT_MODULE_COMMENTS_ADMIN_SETTINGS_AUTH_BUTTONS", "Показывать кнопки авторизации");
...
define("NETCAT_MODULE_COMMENTS_ADMIN_TEMPLATE_SETTINGS_MODERATOR_BLOCK", "Блок модератора");

//subscribe
define("NETCAT_MODULE_COMMENTS_ADMIN_SUBSCRIBE_ADD", "Добавление подписки");
define("NETCAT_MODULE_COMMENTS_ADMIN_SUBSCRIBE_ADD_EXPLAIN", "Необходимо выбрать сущность(сайт, раздел, инфоблок или объект) и пользователя.");
define("NETCAT_MODULE_COMMENTS_ADMIN_SUBSCRIBE_ADD_NOUSER", "Не выбран пользователь");
define("NETCAT_MODULE_COMMENTS_ADMIN_SUBSCRIBE_ADD_NOESSENCE", "Не выбрана сущность");
define("NETCAT_MODULE_COMMENTS_ADMIN_SUBSCRIBE_ADD_SUBSCRIBED", "Пользователь уже подписан на эту сущность");
define("NETCAT_MODULE_COMMENTS_ADMIN_SUBSCRIBE_ADD_OK", "Пользователь %s успешно подписан");
define("NETCAT_MODULE_COMMENTS_ADMIN_SUBSCRIBE_DELETE_CONFIRM", "Будут удалены сделующие подписки");
define("NETCAT_MODULE_COMMENTS_ADMIN_SUBSCRIBE_DELETE_NOTSELECT", "Не выбраны подписки для удаления");
define("NETCAT_MODULE_COMMENTS_ADMIN_SUBSCRIBE_DELETE_OK", "Удалено подписок: %s");
define("NETCAT_MODULE_COMMENTS_ADMIN_SUBSCRIBE_SETTINGS_ALLOW", "доступна подписка на комментарии");
define("NETCAT_MODULE_COMMENTS_ADMIN_SUBSCRIBE_SETTINGS_AUTO", "Автоматически подписывать комментатора");
...
define("NETCAT_MODULE_COMMENTS_ADMIN_SUBSCRIBE_SETTINGS_ADMIN_ALLOW", "Уведомлять администратора о новых комментариях");
define("NETCAT_MODULE_COMMENTS_ADMIN_SUBSCRIBE_SETTINGS_ADMIN_EMAIL", "Email администратора");

define("NETCAT_MODULE_COMMENTS_ADMIN_SUBSCRIBE_LIST_MESSAGE", "Объект %s в инфоблоке %s");
define("NETCAT_MODULE_COMMENTS_ADMIN_SUBSCRIBE_LIST_CC", "Инфоблок %s");
define("NETCAT_MODULE_COMMENTS_ADMIN_SUBSCRIBE_LIST_SUB", "Раздел %s");
define("NETCAT_MODULE_COMMENTS_ADMIN_SUBSCRIBE_LIST_CAT", "Сайт %s");
