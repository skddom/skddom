...
/* $Id: admin.php 6206 2012-02-10 10:12:34Z denis $ */
...
// language constants
if (is_file($MODULE_FOLDER.'cache/'.MAIN_LANG.'.lang.php')) {
    require_once($MODULE_FOLDER.'cache/'.MAIN_LANG.'.lang.php');
} else {
    require_once($MODULE_FOLDER.'cache/en.lang.php');
}
...
require_once ($MODULE_FOLDER."cache/ui_config.php");
