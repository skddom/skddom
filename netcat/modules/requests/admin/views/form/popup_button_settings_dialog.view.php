         ...
         <form class="nc-form nc--vertical" action="<?= $current_url ?>" method="POST">
            ...
            $fields = array(
                ...
                "AnalyticsCategories" => array(
                    'type' => 'custom',
                    'html' => '<div><span class="nc-field-caption">' . NETCAT_MODULE_REQUESTS_FORM_OPEN_EVENT_CATEGORIES . '</span></div>',
                ),
                ...
                "AnalyticsLabels" => array(
                    'type' => 'custom',
                    'html' => '<div><span class="nc-field-caption">' . NETCAT_MODULE_REQUESTS_FORM_OPEN_EVENT_LABELS . '</span></div>',
                ),
