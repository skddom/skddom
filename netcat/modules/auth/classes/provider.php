...
class nc_auth_provider {
    ...
    public function process($params = null) {
        try {
            ...
            echo $this->get_error_message($e);
        }
    }

    public function get_error_message(Exception $e) {
        return '<div class="tpl-block-message tpl-state-error">'
            ...
            . '<div class="tpl-block-message-content">' . NETCAT_MODULE_AUTH_RETRY  . ' ' . $e->getMessage() . '</div>'
            . '</div>';
    }
}