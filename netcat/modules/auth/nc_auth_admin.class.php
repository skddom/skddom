...
class nc_auth_admin {
    ...
    public function ex_show() {
	        ...
	        if ($v === 'oauth') {
		        $html = "<div id='oauth_providers'>
		                    ...
		                    <div class='oauth_header'>
						        <div class='img'><img src='{$this->core->SUB_FOLDER}{$this->core->HTTP_ROOT_PATH}modules/auth/images/icons/oauth.png'></div>
        ...
        echo "<script type='text/javascript'>
                  MODULE_AUTH_OPENID_ICON_PATH = '{$this->core->SUB_FOLDER}{$this->core->HTTP_ROOT_PATH}modules/auth/images/icons/openid.png';
                  MODULE_AUTH_OAUTH_ICON_PATH = '{$this->core->SUB_FOLDER}{$this->core->HTTP_ROOT_PATH}modules/auth/images/icons/oauth.png';
                  nc_mf_vk = new nc_mapping_fields({ " . implode(',', $js_field_user) . " }, { 'uid' : 'ID', 'first_name': '" . NETCAT_MODULE_AUTH_FIRST_NAME . "', 'last_name': '" . NETCAT_MODULE_AUTH_LAST_NAME . "', 'nickname':'" . NETCAT_MODULE_AUTH_NICKNAME . "', 'photo_big' : '" . NETCAT_MODULE_AUTH_PHOTO . "'}, 'vk_mapping', 'nc_mf_vk', '" . NETCAT_MODULE_AUTH_ADMIN_EX_DATA_VK . "' );
                  ...
                  nc_mf_twitter = new nc_mapping_fields({ " . implode(',', $js_field_user) . " }, { 'id' : 'ID', 'name': '" . NETCAT_MODULE_AUTH_FIRST_NAME . "', 'profile_image_url' : '" . NETCAT_MODULE_AUTH_PHOTO . "', 'screen_name':'" . NETCAT_MODULE_AUTH_LOGIN . "'}, 'twitter_mapping', 'nc_mf_twitter', '" . NETCAT_MODULE_AUTH_ADMIN_EX_DATA_TWITTER . "' );
                  ...
                  nc_mf_oauth = new nc_mapping_fields({ " . implode(',', $js_field_user) . " }, { 'uid' : 'ID', 'name': '" . NETCAT_MODULE_AUTH_FIRST_NAME . "', 'nick': '" . NETCAT_MODULE_AUTH_NICKNAME . "', 'photo' : '" . NETCAT_MODULE_AUTH_PHOTO . "'}, 'oauth_mapping', 'nc_mf_oauth', '" . NETCAT_MODULE_AUTH_ADMIN_EX_DATA_OAUTH . "' );
