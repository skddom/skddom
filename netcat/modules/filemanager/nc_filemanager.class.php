...
class nc_filemanager {
    ...
    protected function __construct() {
        ...
        $this->self_path   = $nc_core->MODULE_FOLDER . "filemanager/";
        $this->self_folder = str_replace($nc_core->DOCUMENT_ROOT, "", $this->self_path);
    }
    ...
    public function current($path) {
        ...
        $result = "<link type='text/css' rel='stylesheet' href='" . $this->self_folder . "filemanager.css'>" . // not valid HTML string
