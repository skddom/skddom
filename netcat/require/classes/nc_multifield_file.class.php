...
class nc_multifield_file extends nc_record {
    ...
    protected function save_file() {
        ...
        $relative_folder =
            ...
            ?: $nc_core->HTTP_FILES_PATH . 'multifile/' . $this->multifield->id . '/';
        ...
        // если это картинка...
        if (substr($this->get_mime_type(), 0, 6) == 'image/') {
    ...
    protected function create_image_preview() {
        ...
        if ($this->get_setting('preview_width') && $this->get_setting('preview_height')) {
