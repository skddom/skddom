...
class ui_subdivision_data {
    ...
    function check_rights() {
        ...
        if (!sizeof($this->subclasses)) return;
        ...
        $user_is_moderator = ($perm->isCatalogue($this->catalogue_id, 16) ||
            $perm->isSubdivision($this->subdivision_id, 16));
...
function nc_get_subdivision_children($subdivision_id) {
    ...
    if (empty($parent_subs)) return array();
