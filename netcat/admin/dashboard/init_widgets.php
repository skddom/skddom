...
if ($perm_module_access && ! empty($enabled_modules['search']) ) {
    $nc_core->dashboard->register('mod_search', array(
        ...
        'controller' => $SUB_FOLDER . $HTTP_ROOT_PATH . 'modules/search/widget.php',
        'size'       => array(2,2),
        'color'      => 'purple',
        'fullscreen' => $SUB_FOLDER . $HTTP_ROOT_PATH . 'modules/search/admin.php',
...
if ($perm_module_access && ! empty($enabled_modules['logging']) ) {
    $nc_core->dashboard->register('mod_logging', array(
        ...
        'controller' => $SUB_FOLDER . $HTTP_ROOT_PATH . 'modules/logging/widget.php',
        'size'       => array(4,1),
        'color'      => 'lighten',
...
if ($perm_module_access && ! empty($enabled_modules['comments']) ) {
    $nc_core->dashboard->register('mod_comments', array(
        ...
        'controller' => $SUB_FOLDER . $HTTP_ROOT_PATH . 'modules/comments/widget.php',
        'size'       => array(1,1),
        'color'      => 'cyan',
        'resizeble'  => false,
...
//         'type'       => 'module',
//         'title'      => 'Календарь',
//         'controller' => $SUB_FOLDER . $HTTP_ROOT_PATH . 'modules/calendar/widget.php',
//         'settings'   => true,
//         'size'       => array(2,1),
//         'color'      => 'blue',
//     ));
