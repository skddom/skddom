...
try {
    if (isset($phase)) {
        ...
        if ($phase == 2 || $phase == 4) {
            ...
            $settings_array = $nc_core->component->get_by_id($Class_Template_ID ?: $ClassID, 'CustomSettingsTemplate');
...
if (isset($SubdivisionID) && $SubdivisionID && isset($subdivisionTreeChange) && $subdivisionTreeChange && isset($UI_CONFIG)) {
    ...
    $UI_CONFIG->treeChanges['addNode'][] = array("nodeId" => "sub-$subdivision[Subdivision_ID]",
        ...
        "name"          => $subdivision[Subdivision_ID].". ".strip_tags(str_replace(array("\r", "\n"), '', $subdivision["Subdivision_Name"])),
