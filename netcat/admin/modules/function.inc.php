...
function ModuleList() {
    ...
    if (($modules = $nc_core->modules->get_data(1, 1))) {
        $http_path_to_modules = $nc_core->SUB_FOLDER . $nc_core->HTTP_ROOT_PATH . 'modules/';
        ...
        foreach ($modules as $module) {
            ...
            $admin_file = $nc_core->MODULE_FOLDER . $keyword . '/admin.php';
            $setup_file = $nc_core->MODULE_FOLDER . $keyword . '/setup.php';
            $custom_icon = $nc_core->MODULE_FOLDER . $keyword . '/icon-20x20.png';
            $web_path_to_admin_file = $http_path_to_modules . $keyword . '/admin.php';
            $web_path_to_setup_file = $http_path_to_modules . $keyword . '/setup.php';
            $web_path_to_custom_icon = $http_path_to_modules . $keyword . '/icon-20x20.png';
