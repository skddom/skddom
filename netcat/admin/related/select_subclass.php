<?
/* $Id: select_subclass.php 5946 2012-01-17 10:44:36Z denis $ */
    ...
    <table id='wrapperTable' width='100%' height='100%' border='0' cellpadding='0' cellspacing='0' border='0'>
        ...
        <td id='leftPane' height='100%' bgcolor='#FAFAF9'>
            <iframe name='treeIframe' id='treeIframe'
                    src='<?=$ADMIN_PATH
?>tree_frame.php?mode=related_subclass&field_id=<?=$field_id
?>'
                    height='100%' width='100%' frameborder='0'></iframe>
        </td>
        <td id='slider' width='7' height='100%' valign='top'><div id='slideBar'></div></td>
